...
<!-- Mirrored from portotheme.com/html/wolmart/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Dec 2023 09:58:42 GMT -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{asset('main/assets/images/icons/favicon.png')}}">
    ...
    <link rel="preload" href="{{asset('main/assets/vendor/fontawesome-free/webfonts/fa-regular-400.woff2')}}" as="font" type="font/woff2"
        crossorigin="anonymous">
    <link rel="preload" href="{{asset('main/assets/vendor/fontawesome-free/webfonts/fa-solid-900.woff2')}}" as="font" type="font/woff2"
        crossorigin="anonymous">
    <link rel="preload" href="{{asset('main/assets/vendor/fontawesome-free/webfonts/fa-brands-400.woff2')}}" as="font" type="font/woff2"
        crossorigin="anonymous">
    {{-- <link rel="preload" href="{{asset('main/assets/fonts/wolmart87d5.woff?png09e" as="font" type="font/woff" crossorigin="anonymous"> --}}
            ...
            <div class="header-top">
                <div class="container">
                    ...
                    <div class="header-right">
                        ...
                        <div class="dropdown">
                            <a href="#language"><img src="{{asset('main/assets/images/flags/eng.png')}}" alt="ENG Flag" width="14"
                                    height="8" class="dropdown-image" /> ENG</a>
                            <div class="dropdown-box">
                                <a href="#ENG">
                                    <img src="{{asset('main/assets/images/flags/eng.png')}}" alt="ENG Flag" width="14" height="8"
                                        class="dropdown-image" />
                                    ENG
                                </a>
                                <a href="#FRA">
                                    <img src="{{asset('main/assets/images/flags/fra.png')}}" alt="FRA Flag" width="14" height="8"
                                        class="dropdown-image" />
                                    FRA
                                </a>
                            </div>
                ...
                <div class="container">
                    <div class="header-left mr-md-4">
                        ...
                        <a href="demo1.html" class="logo ml-lg-0">
                            <img src="{{asset('main/assets/images/logo.png')}}" alt="logo" width="144" height="45" />
                        </a>
                            ...
                            <div class="dropdown-box">
                                ...
                                <div class="products">
                                    <div class="product product-cart">
                                        ...
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{asset('main/assets/images/cart/product-1.jpg')}}" alt="product" height="84"
                                                    width="94" />
                                            </a>
                                        </figure>
                                    ...
                                    <div class="product product-cart">
                                        ...
                                        <figure class="product-media">
                                            <a href="product-default.html">
                                                <img src="{{asset('main/assets/images/cart/product-2.jpg')}}" alt="product" width="84"
                                                    height="94" />
                                            </a>
                                        </figure>
                                        <button class="btn btn-link btn-close" aria-label="button">
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="banner-fixed menu-banner menu-banner2">
                                                        <figure>
                                                            <img src="{{asset('main/assets/images/menu/banner-2.jpg')}}" alt="Menu Banner"
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner3">
                                                        <figure>
                                                            <img src="{{asset('main/assets/images/menu/banner-3.jpg')}}" alt="Menu Banner"
                                            ...
                                            <ul class="megamenu">
                                                ...
                                                <li>
                                                    <div class="menu-banner banner-fixed menu-banner4">
                                                        <figure>
                                                            <img src="{{asset('main/assets/images/menu/banner-4.jpg')}}" alt="Menu Banner"
                                                ...
                                                <li class="row">
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="{{asset('main/assets/images/menu/banner-5.jpg')}}" alt="Banner"
                                                    ...
                                                    <div class="col-6">
                                                        <div class="banner banner-fixed menu-banner5 br-xs">
                                                            <figure>
                                                                <img src="{{asset('main/assets/images/menu/banner-6.jpg')}}" alt="Banner"
                                                                    width="410" height="123"
                        ...
                        <div class="col-lg-4 col-sm-6">
                            <div class="widget widget-about">
                                <a href="demo1.html" class="logo-footer">
                                    <img src="{{asset('main/assets/images/logo_footer.png')}}" alt="logo-footer" width="144"
                                        height="45" />
                                </a>
                ...
                <div class="footer-bottom">
                    ...
                    <div class="footer-right">
                        ...
                        <figure class="payment">
                            <img src="{{asset('main/assets/images/payment.png')}}" alt="payment" width="159" height="25" />
                        </figure>
                    </div>
                </div>
            </div>
            ...
            <div class="dropdown-box">
                <div class="products">
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="product-default.html">
                                <img src="{{asset('main/assets/images/cart/product-1.jpg')}}" alt="product" height="84" width="94" />
                            </a>
                        </figure>
                        <button class="btn btn-link btn-close" aria-label="button">
                            <i class="fas fa-times"></i>
                    ...
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="product-default.html">
                                <img src="{{asset('main/assets/images/cart/product-2.jpg')}}" alt="product" width="84" height="94" />
                            </a>
                        </figure>
                        <button class="btn btn-link btn-close" aria-label="button">
                            <i class="fas fa-times"></i>
                        ...
                        <div class="swiper-wrapper row cols-1 gutter-no">
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('main/assets/images/products/popup/1-440x494.jpg')}}"
                                        data-zoom-image="{{asset('main/assets/images/products/popup/1-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('main/assets/images/products/popup/2-440x494.jpg')}}"
                                        data-zoom-image="{{asset('main/assets/images/products/popup/2-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('main/assets/images/products/popup/3-440x494.jpg')}}"
                                        data-zoom-image="{{asset('main/assets/images/products/popup/3-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                            <div class="swiper-slide">
                                <figure class="product-image">
                                    <img src="{{asset('main/assets/images/products/popup/4-440x494.jpg')}}"
                                        data-zoom-image="{{asset('main/assets/images/products/popup/4-800x900.jpg')}}"
                                        alt="Water Boil Black Utensil" width="800" height="900">
                                </figure>
                            </div>
                        </div>
                    ...
                    <div class="product-thumbs-wrap swiper-container" data-swiper-options="{
                        ...
                        <div class="product-thumbs swiper-wrapper row cols-4 gutter-sm">
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('main/assets/images/products/popup/1-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('main/assets/images/products/popup/2-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('main/assets/images/products/popup/3-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                            <div class="product-thumb swiper-slide">
                                <img src="{{asset('main/assets/images/products/popup/4-103x116.jpg')}}" alt="Product Thumb" width="103"
                                    height="116">
                            </div>
                        </div>
                        <button class="swiper-button-next"></button>
            ...
            <div class="col-md-6 overflow-hidden p-relative">
                <div class="product-details scrollable pl-0">
                    ...
                    <div class="product-bm-wrapper">
                        <figure class="brand">
                            <img src="{{asset('main/assets/images/products/brand/brand-1.jpg')}}" alt="Brand" width="102" height="48" />
                        </figure>
...
<!-- Mirrored from portotheme.com/html/wolmart/demo1.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Dec 2023 10:01:01 GMT -->
</html>